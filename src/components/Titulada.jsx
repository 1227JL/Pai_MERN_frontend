  ...
  return (
    <div key={titulada._id} className='flex flex-col shadow-small p-5 rounded-xl'>
        <div className='flex flex-col items-center lg:flex-row lg:justify-between'>
            <p className='font-semibold uppercase'>{titulada?.programa}</p>
        ...
        <Link className='mt-2 lg:mt-0 text-more-100 text-center text-sm font-semibold hover:text-more-200 transition-colors' to={`${titulada?.ficha}`}>Más información</Link>
    </div>
  )
}
