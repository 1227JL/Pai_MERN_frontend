...
export default function Tituladas() {
  const { cargando, tituladas, handleBuscador, handleModalTitulada } =
    useTitulada();
  ...
  const handleCheckboxChange = (event) => {
    ...
    if (event.target.checked) {
      ...
      setFiltros((prevFiltros) =>
        prevFiltros.filter((filtro) => filtro !== checkboxId)
      );
    }
  };
  ...
  return (
    <>
      <h1 className="m-0 text-center">
        Gestiona las <span className="text-slate-600">Tituladas</span>
      </h1>
        ...
        <div className="flex flex-col lg:w-1/3 shadow-small p-5 rounded-xl h-[40rem]">
          ...
          <div className="mt-4 relative">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="tecnologo">Tecnologos</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="tecnico">Técnicos</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="curso corto">Cursos Cortos</label>
            </div>
          </div>
          <div className="mt-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="convocatoria">Convocatorias</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="etapa lectiva">En Formación</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="etapa productiva">En Etapa Productiva</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                ...
                onChange={handleCheckboxChange}
              />
              <label htmlFor="formacion finalizada">Formación Finalizada</label>
            </div>
          </div>
          <div className="mt-4">
          ...
          <Boton
            classes={"bg-primary-100 mt-auto p-4"}
            onClick={handleModalTitulada}
          >
            Agregar Nueva Titulada
          </Boton>
        </div>
        <div className="lg:w-2/3 flex-2">
          <div className="mb-2 flex justify-between items-center">
            <h1 className="m-0">Tituladas</h1>
            <Boton classes={"bg-more-100"} onClick={handleBuscador}>
              Buscar Titulada
            </Boton>
          </div>
          <hr />
          {cargando ? (
            ...
            tituladasFiltradas.length > 0 ? (
              ...
              <h3 className="mt-5 text-center font-bold text-3xl">
