...
import ModalAgregarAprendiz from "../components/ModalAprendiz";
...
export default function TableAprendices() {
  ...
  const { handleModalAprendiz } = useTitulada()
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between gap-3 items-end">
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={handleModalAprendiz} color="success" endContent={<PlusIcon color={'white'} />}>
