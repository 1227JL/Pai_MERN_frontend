...
export default function Login() {
  ...
  return (
    <>
      <h1 className="text-primary-100 font-black text-6xl capitalize">
        Inicia sesión y administra{" "}
        <span className="text-slate-600">el SENA Regional Casanare</span>
      </h1>
      ...
      >
        ...
        <Boton type="submit" classes={"bg-primary-100 mt-auto p-4 w-full"}>
          Iniciar Sesión
        </Boton>
      </form>
